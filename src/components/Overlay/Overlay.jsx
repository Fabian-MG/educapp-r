...
export const Overlay = ({open, setOpen, title, children, onExit, onSuccess}) => {
        ...
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 text-center sm:block sm:p-0">
          ...
          >
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-5/6">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    <Dialog.Title as="h3" className="text-2xl px-4 leading-6 font-medium text-gray-500">
                      {title}
                    </Dialog.Title>
                    <div className="mt-4">
                      {children}
              ...
              <div className="bg-gray-50 py-3 px-9 flex justify-end">
                <div className="mr-4">
                  <Button
                    theme="primary"
                    title="Aceptar"
